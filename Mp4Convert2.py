...
def transcribe_video_audio_to_text(video_file):
    audio_file = "C:\\Hacked_Jan6\\Metamorphosis\\temp_audio2.wav"
    (
    ffmpeg
    .input(video_file)
...
def main():
    video_file = "C:\Hacked_Jan6\Metamorphosis\AnswerRecording2.mp4"
    text_file = "C:\\Hacked_Jan6\\Metamorphosis\\transcribed_text2.txt"
